...
import './DeveloperInfoPop.css'
function DeveloperInfoPop ({ show, onClose, studentName, studentPhotoUrl, uniqueMessage }) {
  if (!show) {
    return null; // Don't render if not visible
  }
  return (
    <div className="popup-overlay"> {/* Covers the wholeef screen, usually semi-transparent */}
...
export default DeveloperInfoPop;